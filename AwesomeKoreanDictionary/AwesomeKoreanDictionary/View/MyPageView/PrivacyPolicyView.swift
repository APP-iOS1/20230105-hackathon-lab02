...
struct PrivacyPolicyView: View {
 ...
 재단은 개인정보를 다음의 목적이외의 용도로는 이용하지 않으며 이용 목적이 변경될 경우 에는 동의를 받아 처리하겠습니다.
 1. 서비스 제공
 홈페이지, 교육콘텐츠 제공, 시찰, 관람, 공모전, 자문단, 강사파견, 동아리, 각종 회의 및 대
 회의 개최와 운영을 목적으로 개인정보를 처리합니다.
 2. 민원, 행정처리
 행정처리, 개인정보 열람, 개인정보 정정·삭제, 개인정보 처리정지 요구, 개인정보 유출사고
 신고, 개인정보 침해사실 신고접수·처리, 스팸민원고충처리, 해킹신고 등 민원처리를 목적으로 개인정보를 처리합니다.
 """
     let securityMeasuresText: String = """
 재단은 법령의 규정과 정보주체의 동의에 의해서만 개인정보를 수집·보유합니다
 """
    let retentionPeriodText: String = """
재단 홈페이지는 고객이 개인정보처리방침 또는 이용약관의 내용에 대한 동의 절차(‘동의한다’ 버튼)를 마련하여, 해당 버튼을 체크하면 개인정보 수집에 대해 동의한 것으로 간주합니다. 또한, 고객은 개인정보 수집에 대해 동의하지 않을 권리가 있으며, 동의하지 않을 경우에는 일부 컨텐츠 이용제한, 민원신청 또는 상담이 거부될 수 있습니다.
"""
    let acceptCollectionText: String = """
재단 홈페이지는 고객이 개인정보처리방침 또는 이용약관의 내용에 대한 동의 절차(‘동의한다’ 버튼)를 마련하여, 해당 버튼을 체크하면 개인정보 수집에 대해 동의한 것으로 간주합니다. 또한, 고객은 개인정보 수집에 대해 동의하지 않을 권리가 있으며, 동의하지 않을 경우에는 일부 컨텐츠 이용제한, 민원신청 또는 상담이 거부될 수 있습니다.
"""
    let thirdPartyProvisionText: String = """
재단이 수집·보유하고 있는 개인정보는 이용자의 동의없이는 제3자에게 제공하지 않으며 다음의 경우에는 개인정보를 제3자에게 제공할 수 있습니다.
...
4. 다음 각 호의 어느 하나에 해당하는 경우에는 정보주체 또는 제3자의 이익을 부당하게 침해할 우려가 있을 때를 제외하고는 이용자의 개인정보 를 목적 외의 용도로 이용하거나 이를 제3자에게 제공할 수 있습니다.
